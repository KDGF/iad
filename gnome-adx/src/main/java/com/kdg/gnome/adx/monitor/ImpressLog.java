 ...
 */
public class ImpressLog extends LogBase {
    public static String VALUE_IMPRESS_LOGTYPE = "ImpressLog";
    ...
    public ImpressLog() {
        this.logType = VALUE_IMPRESS_LOGTYPE;
    }
...
//                .append(token).append("\t")
////                .append(ca.get(Calendar.DAY_OF_MONTH)).append("\t")
