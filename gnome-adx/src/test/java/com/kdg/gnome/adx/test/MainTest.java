...
//        int port = Integer.parseInt(resourceBundle.getString("redis.port"));
        ...
        //初始化连接池
        jedisPool = new JedisPool(config, "211.159.146.73" , 7000, 1000,
                "wzsw=dgsd1g>2qwra3=s41ffs2r+gs3htdgadgsafas3dtq>4efsd?t61gsfgh2=1fghst");
    }
...
//        }
        ...
        MainTest redisClient = new MainTest();
        redisClient.test();
    }
